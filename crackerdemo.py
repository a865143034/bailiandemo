...
def getGoogleList(org,title):
    ...
    for i in range(3):
        for k in range(10):
            tmpurl=f"https://www.google.com.hk/search?q={keyword}%26safe=strict%26hl=zh-CN%26lr=lang_zh-CN%26tbs=cdr:1,cd_min:{datelist[i+1]},cd_max:{datelist[i]}"+f"%26start={k*10}%26pws:pws=0%26filter:1%26tbm="
